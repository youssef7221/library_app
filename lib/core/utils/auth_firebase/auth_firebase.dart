...
class AuthFirebase {
  ...
  static Future<void> signInWithGoogle(Function onSuccess, Function onError) async {
    try {
  ...
  static Future<void> loginUser(String email, String password, Function onSuccess, Function onError) async {
    try {
